...
export function editRecipe(id) {
  ...
  if (recipe.image) {
    ...
    document.getElementById("form-image-preview").classList.add("hidden");
    document
      .getElementById("form-image-placeholder")
...
export async function saveRecipe() {
  ...
  const recipeData = {
    ...
    image: document
      .getElementById("form-image-preview")
      .classList.contains("hidden")
      ? null
      : document.getElementById("form-image-preview").src,
    ingredients: Array.from(document.querySelectorAll(".ingredient-val"))
      .map((i) => i.value)
      .filter((v) => v.trim()),
    instructions: Array.from(document.querySelectorAll(".instruction-val"))
      .map((i) => i.value)
      .filter((v) => v.trim()),
